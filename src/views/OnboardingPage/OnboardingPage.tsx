...
const OnboardingPage = ({
    ...
    const handleCreateCloset = async () => {
        ...
        try {
            ...
            setClosetErr(
                'Could not create closet — you can create one later in My Closet.',
            );
        } finally {
            ...
            <div className={`${styles.card} ${slideClass}`}>
                ...
                {step === 1 && (
                    <StepShell step={1}>
                        ...
                        <p className={styles.sub}>
                            Let's take 60 seconds to set up your wardrobe so Ojo
                            can suggest perfect outfits every day.
                        </p>
                        <div className={styles.illustrationRow}>
                            ...
                            >
                                ...
                                >
                                    <path
                                        d='M12 2a3 3 0 0 1 3 3v1l4 2v14H5V8l4-2V5a3 3 0 0 1 3-3z'
                                        stroke='currentColor'
                                        strokeWidth='1.4'
                            ...
                            >
                                ...
                                >
                                    <path
                                        d='M3 6l4-3h10l4 3-4 4v11H7V10L3 6z'
                                        stroke='currentColor'
                                        strokeWidth='1.4'
                                        strokeLinejoin='round'
                                    />
                            ...
                            >
                                ...
                                >
                                    <path
                                        d='M4 6l3-3 5 3 5-3 3 3v14H4V6z'
                                        stroke='currentColor'
                                        strokeWidth='1.4'
                                        strokeLinejoin='round'
                                    />
                ...
                {step === 2 && (
                    <StepShell step={2}>
                        ...
                        <h2 className={styles.stepHeading}>
                            Name your first closet
                        </h2>
                        <p className={styles.stepDesc}>
                            This will hold your clothes. You can create more
                            later.
                        </p>
                ...
                {step === 3 && (
                    <StepShell step={3}>
                        ...
                        <p className={styles.stepDesc}>
                            Help Ojo suggest outfits that match your style.
                        </p>
