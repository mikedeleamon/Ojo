...
export default function SettingsScreen({ onLogout }: Props) {
  ...
  const dispatch = (action: SettingsAction) => {
    if (action.type === 'navigate') {
      ...
      const doc = action.doc === 'privacy' ? PRIVACY_POLICY : TERMS_OF_SERVICE;
      nav.push('Legal', { doc });
    }
  };
      ...
      <Modal visible={showLogout} transparent animationType="fade">
        ...
        <View style={styles.modalCard}>
          ...
          <View style={styles.modalActions}>
            <Pressable style={styles.modalCancel} onPress={() => setShowLogout(false)}>
...
const styles = StyleSheet.create({
  ...
  logoutText: { fontFamily: fonts.body, fontSize: fontSizes.base, color: colors.textSecondary },
  ...
  modalTitle:       { fontFamily: fonts.body, fontSize: 17, fontWeight: fontWeights.semibold, color: colors.textPrimary },
  modalBody:        { fontFamily: fonts.body, fontSize: 14, color: colors.textSecondary, lineHeight: 14 * 1.6 },
  ...
  modalCancelText:  { fontFamily: fonts.body, fontSize: fontSizes.base - 1, fontWeight: fontWeights.medium, color: colors.textSecondary },
  modalConfirm: {
    flex: 1, paddingVertical: 12,
    backgroundColor: colors.glassBg, borderWidth: 1, borderColor: colors.glassBorder,
    borderRadius: radius.sm, alignItems: 'center',
  },
  modalConfirmText: { fontFamily: fonts.body, fontSize: fontSizes.base - 1, fontWeight: fontWeights.medium, color: colors.textPrimary },
});
