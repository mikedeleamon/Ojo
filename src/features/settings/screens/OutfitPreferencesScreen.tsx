...
const STYLES = ['Casual', 'Business Casual', 'Formal', 'Athletic', 'Streetwear', 'Minimalist', 'Urban', 'Cozy', 'Preppy'];
...
const OutfitPreferencesScreen = () => {
  ...
  const save = () => submit(() => saveSettings({ ...settings, clothingStyle: style }));
