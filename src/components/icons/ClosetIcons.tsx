...
export const SearchIcon = ({ size = 16, color = DEFAULT_COLOR, strokeWidth = 1.5, decorative = true }: IconProps) => (
...
export const TripFitIcon = ({ size = 24, decorative = true }: { size?: number; decorative?: boolean }) => (
    <Svg
        width={size}
        height={size}
        viewBox='0 0 64 64'
...
export const CheckIcon = ({ size = 16, color = DEFAULT_COLOR, strokeWidth = 1.8, decorative = true }: IconProps) => (
    <Svg {...base(size, color, strokeWidth, decorative)}>
        <Path d='M20 6L9 17l-5-5' />
    </Svg>
);

export const CloseIcon = ({ size = 16, color = DEFAULT_COLOR, strokeWidth = 1.6, decorative = true }: IconProps) => (
    <Svg {...base(size, color, strokeWidth, decorative)}>
...
export const SortIcon = ({ size = 18, color = DEFAULT_COLOR, strokeWidth = 1.5, decorative = true }: IconProps) => (
    <Svg {...base(size, color, strokeWidth, decorative)}>
...
export const FilterIcon = ({ size = 16, color = DEFAULT_COLOR, strokeWidth = 1.5, decorative = true }: IconProps) => (
    <Svg {...base(size, color, strokeWidth, decorative)}>
...
export const GridIcon = ({ size = 18, color = DEFAULT_COLOR, strokeWidth = 1.5, decorative = true }: IconProps) => (
    <Svg {...base(size, color, strokeWidth, decorative)}>
...
export const ListIcon = ({ size = 18, color = DEFAULT_COLOR, strokeWidth = 1.5, decorative = true }: IconProps) => (
    <Svg {...base(size, color, strokeWidth, decorative)}>
...
export const MoreIcon = ({ size = 18, color = DEFAULT_COLOR, strokeWidth = 1.5, decorative = true }: IconProps) => (
    <Svg {...base(size, color, strokeWidth, decorative)}>
...
export const PlusIcon = ({ size = 20, color = DEFAULT_COLOR, strokeWidth = 1.6, decorative = true }: IconProps) => (
    <Svg {...base(size, color, strokeWidth, decorative)}>
        <Path d='M12 5v14M5 12h14' />
    </Svg>
);

export const ChevronRightIcon = ({ size = 18, color = DEFAULT_COLOR, strokeWidth = 1.5, decorative = true }: IconProps) => (
    <Svg {...base(size, color, strokeWidth, decorative)}>
        <Path d='M9 6l6 6-6 6' />
    </Svg>
);
