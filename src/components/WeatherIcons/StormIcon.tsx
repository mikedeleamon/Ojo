...
export const BOLT_LEFT_PTS =
    '372.65 911.63 326.1 974.47 264.52 820.79 342.01 834.18 319.77 778.28 367.43 786.26 330.47 693.34 485.06 720.37 428.52 797.12 474.39 805.39 381.27 931.35 372.65 911.63';

export const BOLT_CENTER_PTS =
    '619.64 1040.62 573.83 1102.59 512.66 949.67 588.76 962.91 566.67 906.77 614.37 914.74 577.53 821.5 732.3 848.57 675.52 925.62 721.32 933.86 628.29 1060.37 619.64 1040.62';

export const BOLT_RIGHT_PTS =
    '877.48 887.01 831.05 949.6 769.68 796.7 846.95 810.03 824.75 754.24 872.42 762.24 835.47 669.34 990.29 696.42 933.5 773.12 979.39 781.39 886.28 907.38 877.48 887.01';
...
export default function StormIcon({ size = 180, color = '#fefefe', decorative = false }: StormIconProps) {
    return (
        ...
        >
            ...
            <Polygon id="bolt-right"  fill={color} points={BOLT_RIGHT_PTS} />
        </Svg>
    );
}
