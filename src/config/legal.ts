...
export const TERMS_OF_SERVICE: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        'Ojo is a free mobile wardrobe management application that allows users to create and manage a digital wardrobe, receive outfit suggestions generated by on-device machine learning models based on their wardrobe and local weather conditions, and track outfit wear history.',
