...
export default class HotWeatherPreferencesScreen extends Component{
	constructor(props){
		super(props)
		this.state = {
            hotLimit: 85,
     ...
     return(
         <LinearGradient colors = {["#86FF8A","#FFF119"]} style = {WeatherPreferenceStyle.container}>
             <View style= {WeatherPreferenceStyle.card}>
                <Text style = {WeatherPreferenceStyle.headerText}> Hot Point </Text>
                 <Text style = {WeatherPreferenceStyle.text}>
                     At what point does it get too hot for you?
                 </Text>
                 <SliderOption/>
                 <TouchableOpacity 
                    onPress={()=> navigate('ColdWeatherPreferencesScreen')}
