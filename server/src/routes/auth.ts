...
router.post('/signup', async (req: Request, res: Response): Promise<void> => {
  try {
    // Builds 30 and 31 also send `birthday`. It is ignored, not stored: App
    // Review rejected the required date of birth under guideline 5.1.1(v), and
    // nothing in Ojo uses it.
