...
export default function AccountLayout() {
    ...
    return (
        <Stack screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen
                name='profile'
                options={{ ...subScreen, title: 'Profile' }}
            />
            <Stack.Screen
                name='upgrade'
                options={{ ...subScreen, title: 'Ojo Pro' }}
            />
            <Stack.Screen
                name='password'
                options={{ ...subScreen, title: 'Password' }}
            />
            <Stack.Screen
                name='history'
                options={{ ...subScreen, title: 'History' }}
            />
            ...
            <Stack.Screen
                name='preferences'
                options={{ ...subScreen, title: 'Style Preferences' }}
            />
            <Stack.Screen
                name='location'
                options={{ ...subScreen, title: 'Location' }}
            />
            <Stack.Screen
                name='locations'
                options={{ ...subScreen, title: 'Locations' }}
            />
            <Stack.Screen
                name='units'
                options={{ ...subScreen, title: 'Units' }}
            />
            <Stack.Screen
                name='price-backfill'
                options={{ ...subScreen, title: 'Add Prices' }}
            />
            <Stack.Screen
                name='notifications'
                options={{ ...subScreen, title: 'Notifications' }}
            />
            <Stack.Screen
                name='trip-mode'
                options={{ ...subScreen, title: 'Trip Mode' }}
            />
            <Stack.Screen
                name='permissions'
                options={{ ...subScreen, title: 'Permissions' }}
            />
            <Stack.Screen
                name='data-usage'
                options={{ ...subScreen, title: 'Data Usage' }}
            />
            <Stack.Screen
                name='legal'
                options={{ ...subScreen, title: 'Legal' }}
            />
        </Stack>
    );
}
